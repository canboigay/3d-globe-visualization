...
function Globe3DEnhanced({
  ...
  const altitudeTimerRef = useRef(null);
  const borderArcsRef = useRef([]);
  ...
  useEffect(() => {
    ...
    const init = () => {
      try {
        ...
        const globe = Globe().globeImageUrl(textureConfig.globe).backgroundColor("rgba(0,0,0,0)").showAtmosphere(showAtmosphere).atmosphereColor(atmosphereColor).atmosphereAltitude(0.15).onGlobeReady(() => {
          if (destroyedRef.current) return;
          try {
  ...
  const flyTo = useCallback((lat, lng, alt = 1.5) => {
    if (globeRef.current) {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        loading && /* @__PURE__ */ jsx("div", { style: {
        ...
        }, children: /* @__PURE__ */ jsxs("div", { style: { textAlign: "center", color: "#9ca3af" }, children: [
          ...
          /* @__PURE__ */ jsx("div", { children: "Loading globe..." })
        ] }) }),
        error && /* @__PURE__ */ jsx("div", { style: {
          ...
          /* @__PURE__ */ jsx("div", { style: { fontSize: 18, fontWeight: 600, marginBottom: 8 }, children: "Failed to load" }),
          /* @__PURE__ */ jsx("div", { style: { fontSize: 14, color: "#9ca3af" }, children: error })
        ] }) }),
        /* @__PURE__ */ jsx(
          "div",
          {
...
import { useRef as useRef2, useEffect as useEffect2, useState as useState2, useCallback as useCallback2, useMemo as useMemo2 } from "react";
import * as THREE2 from "three";
import Globe2 from "globe.gl";
...
function Globe3DWarGame({
  ...
  const globeContainerRef = useRef2(null);
  const globeRef = useRef2(null);
  const [isReady, setIsReady] = useState2(false);
  const [currentTexture, setCurrentTexture] = useState2(texture);
  const [hoveredTexture, setHoveredTexture] = useState2(null);
  const borderArcsRef = useRef2([]);
  const destroyedRef = useRef2(false);
  const mergedColors = useMemo2(() => ({ ...LEVEL_COLORS, ...colors }), [colors]);
  useEffect2(() => {
    ...
    const init = () => {
      try {
        if (destroyedRef.current) return;
        const textureConfig = TEXTURE_URLS[currentTexture];
        const globe = Globe2().globeImageUrl(textureConfig.globe).backgroundColor("rgba(0,0,0,0)").showAtmosphere(showAtmosphere).atmosphereColor(ATMOSPHERE_COLORS[currentTexture]).atmosphereAltitude(0.15).onGlobeReady(() => {
          if (destroyedRef.current) return;
          try {
            const mat = globe.globeMaterial();
            const { color, intensity } = EMISSIVE_SETTINGS[currentTexture];
  ...
  const switchTexture = useCallback2((newTexture) => {
  ...
  const flyTo = useCallback2((lat, lng, alt = 1.5) => {
    if (globeRef.current) {
      globeRef.current.pointOfView({ lat, lng, altitude: alt }, 1500);
    }
  }, []);
  const criticalCount = useMemo2(() => data.filter((d) => d.level === "critical").length, [data]);
  const highCount = useMemo2(() => data.filter((d) => d.level === "high").length, [data]);
  ...
  return /* @__PURE__ */ jsxs2(
    "div",
    {
      ...
      children: [
        loading && /* @__PURE__ */ jsx2("div", { style: {
          position: "absolute",
          inset: 0,
          zIndex: 60,
          display: "flex",
          ...
          justifyContent: "center",
          background: "rgba(0,0,0,0.9)"
        }, children: /* @__PURE__ */ jsxs2("div", { style: { textAlign: "center", color: "#9ca3af" }, children: [
          ...
          /* @__PURE__ */ jsx2("div", { style: { letterSpacing: 2, textTransform: "uppercase", fontSize: 13 }, children: "INITIALIZING..." })
        ] }) }),
        error && /* @__PURE__ */ jsx2("div", { style: {
          ...
          /* @__PURE__ */ jsx2("div", { style: { fontSize: 16, fontWeight: 700, letterSpacing: 2, marginBottom: 8 }, children: "SYSTEM ERROR" }),
          /* @__PURE__ */ jsx2("div", { style: { fontSize: 13, color: "#9ca3af" }, children: error })
        ] }) }),
        /* @__PURE__ */ jsxs2("div", { style: {
          ...
          /* @__PURE__ */ jsx2("div", { style: { fontSize: 20, fontWeight: 700, letterSpacing: 3, color: "#e8eaed" }, children: "THREAT INTELLIGENCE" }),
          /* @__PURE__ */ jsxs2("div", { style: { fontSize: 13, color: "#9ca3af", letterSpacing: 1 }, children: [
            "THREATS: ",
            /* @__PURE__ */ jsx2("span", { style: { color: "#e8eaed", fontWeight: 600 }, children: data.length }),
            /* @__PURE__ */ jsx2("span", { style: { margin: "0 12px", opacity: 0.3 }, children: "|" }),
            "MODE: ",
            /* @__PURE__ */ jsx2("span", { style: { color: "#e8eaed", fontWeight: 600 }, children: TEXTURE_LABELS[currentTexture] })
          ] })
        ] }),
        criticalCount > 0 && /* @__PURE__ */ jsxs2("div", { style: {
          position: "absolute",
          top: 75,
          left: 20,
          zIndex: 50,
        ...
        showScanLine && isReady && /* @__PURE__ */ jsx2("div", { style: {
          position: "absolute",
          inset: 0,
          zIndex: 10,
          pointerEvents: "none",
        ...
        /* @__PURE__ */ jsx2("div", { style: {
          ...
          backdropFilter: "blur(10px)",
          maxWidth: "90%"
        }, children: allTextures.map((t) => /* @__PURE__ */ jsx2(
          "button",
          {
...
function Starfield({
  ...
  const starsRef = useRef3([]);
  const animationRef = useRef3(0);
  const timeRef = useRef3(0);
  const planetOpacityRef = useRef3(0);
  const isVisibleRef = useRef3(true);
  const initStars = useCallback3((width, height) => {
    const stars = [];
  ...
  const drawPlanet = useCallback3((ctx, x, y, size, color, hasRing, name, opacity) => {
...
import { useState as useState3, useRef as useRef4, useEffect as useEffect4, useCallback as useCallback4, useMemo as useMemo3 } from "react";
...
function TimelineSlider({
  ...
  const playbackRef = useRef4(null);
  const containerRef = useRef4(null);
  const timeRangeRef = useRef4(timeRange);
  ...
  const maxHistogram = useMemo3(() => Math.max(1, ...histogram), [histogram]);
  ...
  const handleSliderClick = useCallback4((e) => {
  ...
  return /* @__PURE__ */ jsxs3(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs3("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: 8 }, children: [
          /* @__PURE__ */ jsx4("span", { style: { fontSize: 11, color: "#9ca3af", letterSpacing: 0.5 }, children: formatTime(new Date(timeBounds.min)) }),
          /* @__PURE__ */ jsx4("span", { style: { fontSize: 12, color: "#e8eaed", fontWeight: 600, letterSpacing: 0.5 }, children: formatTime(timeRange.end) }),
          /* @__PURE__ */ jsx4("span", { style: { fontSize: 11, color: "#9ca3af", letterSpacing: 0.5 }, children: formatTime(new Date(timeBounds.max)) })
        ] }),
        /* @__PURE__ */ jsxs3(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsx4("div", { style: { display: "flex", alignItems: "flex-end", height: 32, gap: 1 }, children: histogram.map((count, i) => {
        ...
        /* @__PURE__ */ jsxs3("div", { style: { display: "flex", alignItems: "center", gap: 10 }, children: [
          ...
          /* @__PURE__ */ jsxs3("span", { style: { fontSize: 11, color: "#6b7280", letterSpacing: 0.5 }, children: [
            data.filter((d) => {
          ...
          /* @__PURE__ */ jsxs3("span", { style: { fontSize: 11, color: "#6b7280", marginLeft: "auto" }, children: [
            playbackSpeed,
            "x"
          ] })
        ] })
...
function SearchFilter({
  ...
  const toggleLevel = useCallback5((level) => {
  ...
  const setSearch = useCallback5((search) => {
    onChange({ ...filters, search: search || void 0 });
  }, [filters, onChange]);
  const setCountry = useCallback5((country) => {
    if (!country) {
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs4("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
            /* @__PURE__ */ jsx5("span", { style: { fontSize: 13, color: "#e8eaed", fontWeight: 600, letterSpacing: 0.5 }, children: "FILTERS" }),
            activeFilterCount > 0 && /* @__PURE__ */ jsx5("span", { style: {
          ...
          /* @__PURE__ */ jsx5("span", { style: { color: "#6b7280", fontSize: 12, transition: "transform 0.2s", transform: isExpanded ? "rotate(180deg)" : "" }, children: "\\u25BC" })
        ]
      }
    ),
    isExpanded && /* @__PURE__ */ jsxs4("div", { style: { padding: "0 14px 14px" }, children: [
      /* @__PURE__ */ jsx5(
        "input",
        {
          type: "text",
      ...
      /* @__PURE__ */ jsxs4("div", { style: { marginBottom: 12 }, children: [
        /* @__PURE__ */ jsx5("div", { style: { fontSize: 10, color: "#6b7280", marginBottom: 6, letterSpacing: 1, textTransform: "uppercase" }, children: "Severity" }),
        /* @__PURE__ */ jsx5("div", { style: { display: "flex", gap: 6, flexWrap: "wrap" }, children: ALL_LEVELS.map((level) => /* @__PURE__ */ jsx5(
          "button",
          {
      ...
      availableCountries.length > 0 && /* @__PURE__ */ jsxs4("div", { style: { marginBottom: 12 }, children: [
        /* @__PURE__ */ jsx5("div", { style: { fontSize: 10, color: "#6b7280", marginBottom: 6, letterSpacing: 1, textTransform: "uppercase" }, children: "Country" }),
        /* @__PURE__ */ jsxs4(
          "select",
          {
            ...
            children: [
              /* @__PURE__ */ jsx5("option", { value: "", children: "All Countries" }),
              availableCountries.map((c) => /* @__PURE__ */ jsx5("option", { value: c, children: c }, c))
            ]
          }
        )
      ] }),
...
function ExportButton({
  ...
  const [exporting, setExporting] = useState5(null);
  const handleExport = useCallback6(async (format) => {
    setExporting(format);
    try {
      switch (format) {
        case "png": {
  ...
  return /* @__PURE__ */ jsxs5("div", { style: { position: "relative" }, children: [
    /* @__PURE__ */ jsx6(
      "button",
      {
    ...
    isOpen && /* @__PURE__ */ jsx6("div", { style: {
      position: "absolute",
      bottom: "100%",
      right: 0,
      marginBottom: 8,
    ...
    }, children: formats.filter((f) => f !== "svg").map((format) => /* @__PURE__ */ jsxs5(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsx6("span", { children: formatIcons[format] }),
          /* @__PURE__ */ jsx6("span", { children: formatLabels[format] }),
          exporting === format && /* @__PURE__ */ jsx6("span", { style: {
            marginLeft: "auto",
            width: 14,
            height: 14,
    ...
    /* @__PURE__ */ jsx6("style", { children: `@keyframes exp-spin { to { transform: rotate(360deg) } }` })
  ] });
}

// src/hooks/useGlobe.ts
import { useRef as useRef5, useEffect as useEffect5, useCallback as useCallback7, useState as useState6 } from "react";
import * as THREE3 from "three";
import Globe3 from "globe.gl";
function useGlobe(options) {
  const globeRef = useRef5(null);
  const [isReady, setIsReady] = useState6(false);
  const [altitude, setAltitude] = useState6(options.initialPosition?.altitude ?? 2.2);
  const altitudeTimerRef = useRef5(null);
  const borderArcsRef = useRef5([]);
  const destroyedRef = useRef5(false);
  useEffect5(() => {
  ...
  useEffect5(() => {
    ...
    const init = () => {
      try {
        ...
        const globe = Globe3().globeImageUrl(textureConfig.globe).backgroundColor("rgba(0,0,0,0)").showAtmosphere(options.showAtmosphere !== false).atmosphereColor(atmosphereColor).atmosphereAltitude(0.15).onGlobeReady(() => {
          if (destroyedRef.current) return;
          try {
            const mat = globe.globeMaterial();
  ...
  const flyTo = useCallback7((lat, lng, alt = 1.5) => {
    if (globeRef.current) {
      globeRef.current.pointOfView({ lat, lng, altitude: alt }, 1500);
    }
  }, []);
  const setTexture = useCallback7((texture) => {
    if (!globeRef.current || destroyedRef.current) return;
    const g = globeRef.current;
    const config = TEXTURE_URLS[texture];
    g.globeImageUrl(config.globe);
